...
localStorage.setItem("refreshToken", res.data.refresh);
  ...
  return (
    <div className="min-h-[calc(100vh-72px)] bg-[#F8FAFC] flex font-sans antialiased text-slate-800">
      ...
      <div className="w-full lg:w-[58%] flex flex-col justify-between p-6 sm:p-12 relative">
        ...
        <div className="max-w-xl w-full mx-auto my-auto bg-white border border-slate-100 rounded-2xl p-6 sm:p-10 shadow-sm">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-xs text-slate-400 mt-0.5">Log in to your account to continue building smart.</p>
          </div>
          ...
          <form onSubmit={loginUser} className="space-y-4">
            ...
            {/* Remember Me & Forgot Password context alignment features */}
            <div className="flex items-center justify-between pt-1 text-xs">
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="remember" className="text-slate-500 font-medium select-none">
                  Remember me
                </label>
              </div>
          ...
          <div className="relative my-6 text-center">
            ...
            <span className="relative bg-white px-3 text-xs text-slate-400 font-medium">or login with</span>
          </div>
